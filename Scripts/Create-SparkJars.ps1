...
$jars = Get-ChildItem "$SparkHome\assembly\target\scala-2.10","$SparkHome\examples\target\scala-2.10","$SparkHome\lib_managed\jars\datanucleus-*.jar","$SharkHome\target\scala-2.10","$SharkHome\lib_managed\jars\edu.berkeley.cs.shark","$SharkHome\lib_managed\jars\javax.jdo\jdo2-api","$SharkHome\lib_managed\jars\org.apache.thrift","$scriptLocation\..\CommonJars" -Recurse -Include *.jar,*.exe
